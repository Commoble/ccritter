...
// this doesn't extend TileEntityChest because there's some issues with double chests
public class TileEntityChestDeep extends TileEntity implements IInventory
{
	private ItemStack[] chestContents = new ItemStack[36];
    /** Determines if the check for adjacent chests has taken place. */
    //public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestDeep adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestDeep adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestDeep adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestDeep adjacentChestZPos;
    ...
    public TileEntityChestDeep()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityChestDeep(int i)
    {
    ...
    public ItemStack decrStackSize(int slot, int count)
    {
        if (this.chestContents[slot] != null)
        {
            ...
            {
                itemstack = this.chestContents[slot].splitStack(count);
    ...
    public void checkForAdjacentChests()
    {
        /*if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityChestDeep)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityChestDeep)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityChestDeep)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityChestDeep)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        else
        {
            ...
            return block instanceof BlockChestDeep && ((BlockChestDeep)block).power == this.func_145980_j();
        }
    }
    ...
    {
        if (this.getBlockType() instanceof BlockChestDeep)
        {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numPlayersUsing);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockChestDeep))
            {
                return 0;
            }

            // this field has to do with powering
            this.cachedChestType = ((BlockChestDeep)this.getBlockType()).power;
        }
