...
public class RenderGnomeDeep extends RenderLiving
{
	private static final ResourceLocation texture = new ResourceLocation("ccritter:textures/entities/gnomedeep.png");  //refers to:assets/yourmod/textures/entity/yourtexture.png
    ...
    public RenderGnomeDeep(ModelBase modelbase, float f)
    {
        super(modelbase, f);
    ...
    public void renderGnomeDeep(EntityGnomeDeep ent, double d, double d1, double d2, 
            float f, float f1)
    {
    ...
    public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2, 
            float f, float f1)
    {
    	renderGnomeDeep((EntityGnomeDeep)entityliving, d, d1, d2, f, f1);
    }

    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
    	renderGnomeDeep((EntityGnomeDeep)entity, d, d1, d2, f, f1);
    }
    ...
    protected void renderEquippedItems(EntityLivingBase ent, float par2)
    {
    	...
    	EntityGnomeDeep gnome = (EntityGnomeDeep)ent;
